...
Mat ImageMonochrome(const Mat image) ;						            // Convertir une image en niveau gris
Mat ImageInversementMono(const Mat image) ;				                // Inverser une image en niveau gris
...
Mat NormalisationMono(const Mat image) ;                                // Normalisation de l'histogramme d'une image au niveau gris
Mat Normalisation(const Mat image) ;                                    // Normalisation de l'histogramme d'une image en couleurs
Mat ImageEgalisationMono(const Mat image) ;                             // Egalisation d'une image en niveau gris
